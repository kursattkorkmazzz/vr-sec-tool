 ...
 * 
 * This module hooks into Unity's UnityWebRequest class to intercept,
 * log, and optionally modify all HTTP/HTTPS network requests made
 * by Unity-based VR applications.
 * 
 * Hooked methods:
 * - Constructor overloads (String, String+String, String+String+DownloadHandler+UploadHandler)
 * - set_url: Intercepts URL changes
 * - set_uploadHandler: Intercepts payload modifications
 * 
...
/**
 * Platform handler for intercepting UnityWebRequest network calls.
...
export default class UnityWebRequestPlatform implements IPlatform {
  /**
   * Initializes all UnityWebRequest hooks.
   * Locates the UnityEngine.Networking.UnityWebRequest class and
   * attaches implementation hooks to constructors and setters.
   */
