...
.method protected getCamera2Count()I
    ...
    invoke-static {p0}, Lcom/unity3d/player/r;->a(Landroid/content/Context;)I
...
.method protected getCamera2FocalLengthEquivalent(I)I
    ...
    invoke-static {p0, p1}, Lcom/unity3d/player/r;->a(Landroid/content/Context;I)I
...
.method protected getCamera2Resolutions(I)[I
    ...
    invoke-static {p0, p1}, Lcom/unity3d/player/r;->b(Landroid/content/Context;I)[I
...
.method protected getCamera2SensorOrientation(I)I
    ...
    invoke-static {p0, p1}, Lcom/unity3d/player/r;->c(Landroid/content/Context;I)I
...
.method protected getFrameSizeCamera2()Landroid/graphics/Rect;
    ...
    iget-object p0, p0, Lcom/unity3d/player/Camera2Wrapper;->b:Lcom/unity3d/player/r;

    if-eqz p0, :cond_0

    invoke-virtual {p0}, Lcom/unity3d/player/r;->c()Landroid/graphics/Rect;
...
.method protected isCamera2AutoFocusPointSupported(I)Z
    ...
    invoke-static {p0, p1}, Lcom/unity3d/player/r;->d(Landroid/content/Context;I)Z
...
.method protected isCamera2FrontFacing(I)Z
    ...
    invoke-static {p0, p1}, Lcom/unity3d/player/r;->e(Landroid/content/Context;I)Z
...
.method protected pauseCamera2()V
    ...
    invoke-virtual {p0}, Lcom/unity3d/player/r;->d()V
...
.method protected setAutoFocusPoint(FF)Z
    ...
    invoke-virtual {p0, p1, p2}, Lcom/unity3d/player/r;->a(FF)Z
...
.method protected startCamera2()V
    ...
    invoke-virtual {p0}, Lcom/unity3d/player/r;->h()V
